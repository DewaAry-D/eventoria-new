<div class="w-full p-md sm:p-lg xl:p-xl space-y-lg sm:space-y-xl select-none">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-sm sm:gap-md w-full">
        ...
        <x-admin.cards.stat-card-bento :value="$cardsData['eventBerlangsung']" title="Event Berhasil" badgeText="Lolos Review" badgeType="success" iconBg="primary">
            <x-slot name="icon">
        ...
        <x-admin.cards.stat-card-bento :value="$cardsData['pendingOrg']" title="Pengajuan Organisasi" badgeText="Pending" badgeType="warning" iconBg="warning">
            <x-slot name="icon">
        ...
        <x-admin.cards.stat-card-bento :value="$cardsData['pendingEvent']" title="Pengajuan Event" badgeText="Review" badgeType="warning" iconBg="warning">
            <x-slot name="icon">
